...
from storyteller.algorithm.mcts_action import SelectNextVisualizationTaskAction, GenerateVisualizationAction, ReviseVisualizationAction
import copy
    ...
    if visualization_nodes:
        ...
        if chapter.charts:
            ...
            for i, chart in enumerate(chapter.charts):
                ...
                print(f"      代码长度: {len(chart.code) if chart.code else 0} 字符")
